...
正式版候选仅修改主程序版本元数据，已完成[针对性审查](reviews/2026-09-24-v1.2-final-metadata.md)后重新构建签名。主程序安装包 SHA-256 为 `A8DD9AD7BBC6EFD095D257E44288DCE79C27CC1EBC91428B5EB59F539D4B802A`；本机清单工具对安装包、`.sig`、Beta.1 组件 ZIP 和 `latest.json` 的版本、签名及地址复验通过，桥接 smoke 14/14 通过。正式版[发布说明草稿](releases/v1.2.0.md)已写就；默认/自选路径升级、签名更新、组件安装/卸载及旧书库副本仍待安装版走查。
