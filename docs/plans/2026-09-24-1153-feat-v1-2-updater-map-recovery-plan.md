...
- **Stop condition:** 若[发布前审查](../reviews/2026-09-24-v1.2-pre-release.md)的阻断项未修复并复审、签名密钥无法安全保存、更新链路不能在 Windows 安装版验证、v1.1.0 侧车迁移可能被安装器删除，或续跑会错误复用已变化的原文，不发布 v1.2.0。
