...
- `cd app/src-tauri && cargo test`：143 项通过（含 `pdfparse_contract` 8 项、`pdfmap` 映射层内联 23 项与实测 fixture 5 篇、`pdfassets_contract` 5 项预渲染全链）。
